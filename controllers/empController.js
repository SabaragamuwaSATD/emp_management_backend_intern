...
const { sendAutoGeneratedPassword } = require("../utills/emailService");
...
exports.addEmployee = async (req, res, next) => {
  try {
    ...
    //automatically generate one time password
    const password = Math.floor(Math.random() * 0xffffff)
      .toString(16)
      .padStart(6, "0");
    ...
    await sendAutoGeneratedPassword(email, password);
    res.status(201).json({
      success: true,
      data: newEmployee,
    });
